...
// ============================================================================
// CORE ENGINE — `processPackingBoxAsContainer` was removed during the
// sticker-generation migration.  The container + pallet routing it used
// to perform now runs inside the `sg_auto-generate` edge function (Phase
// 5 in memory simulation + bulk writes), preserving identical business
// logic server-side.
// ============================================================================
...
// fetchPalletContainers was removed during the Pallet Dashboard migration
// and is now served by the `pac_dashboard_get-containers` edge function.
