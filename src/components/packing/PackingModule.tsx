/**
 * PackingModule — FG Packing Workflow (v7 — Cards + Responsive + Eye Icon + Date Filters).
 *
...
export function PackingModule({ accessToken, userRole }: PackingModuleProps) {
    ...
    const dateButtonStyle: React.CSSProperties = {
        ...
        color: 'var(--enterprise-gray-700, #374151)',
        position: 'relative', whiteSpace: 'nowrap' as const, flexShrink: 0,
    };
    const CalendarIcon = () => (
        ...
        <div>
            ...
            <div className="summary-cards-grid" style={{
                ...
                <SummaryCard
                    ...
                    icon={<IconProgress />}
                    color="#7c3aed" bgColor="rgba(124,58,237,0.1)"
                ...
                />
                <SummaryCard
                    label="Partial Transfer" value={counts.PARTIALLY_TRANSFERRED}
                    icon={<IconPartial />}
                    color="#d97706" bgColor="rgba(217,119,6,0.1)"
                    isActive={statusFilter === 'PARTIALLY_TRANSFERRED'} onClick={() => setStatusFilter('PARTIALLY_TRANSFERRED')}
                />
            </div>
            ...
            <div className="filter-bar" style={{
                display: 'flex', alignItems: 'center', marginBottom: '16px', gap: '10px', flexWrap: 'wrap',
                ...
                <div style={{
                    ...
                    border: '1px solid var(--enterprise-gray-300, #d1d5db)',
                    borderRadius: '6px', padding: '8px 12px', flex: 1, minWidth: '220px',
                }}>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--enterprise-gray-400, #9ca3af)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: 8, flexShrink: 0 }}>
                        <circle cx="11" cy="11" r="8" /><line x1="21" y1="21" x2="16.65" y2="16.65" />
                    </svg>
                    <input
                        type="text" placeholder="Search movement #, item, part no..."
                        value={searchTerm} onChange={e => setSearchTerm(e.target.value)}
                        style={{
                            border: 'none', outline: 'none', flex: 1, fontSize: '13px',
                            color: 'var(--enterprise-gray-800, #111827)', background: 'transparent', minWidth: '140px',
                        }}
                    />
                    {searchTerm && (
                        <button onClick={() => setSearchTerm('')} style={{
                            ...
                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="var(--enterprise-gray-600, #4b5563)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                {/* Date From — Button style */}
                <label style={{ ...dateButtonStyle, color: dateFrom ? '#1e3a8a' : '#6b7280' }}>
                    <CalendarIcon />
                ...
                {/* Date To — Button style */}
                <label style={{ ...dateButtonStyle, color: dateTo ? '#1e3a8a' : '#6b7280' }}>
                    <CalendarIcon />
                ...
                {(dateFrom || dateTo) && (
                    <button onClick={() => { setDateFrom(''); setDateTo(''); }} style={{
                        ...dateButtonStyle, color: '#dc2626', padding: '7px 10px',
                ...
                <select
                    ...
                    style={{
                        ...
                        border: '1px solid var(--enterprise-gray-300, #d1d5db)', fontSize: 13,
                        color: 'var(--enterprise-gray-800, #111827)',
                        background: 'var(--enterprise-gray-50, #f9fafb)',
