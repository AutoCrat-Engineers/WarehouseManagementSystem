...
const MODULE_CONFIG: ModuleConfig[] = [
    ...
    },
    {
        ...
        icon: Package,
        color: '#8b5cf6',
        description: 'FG catalog & stock view',
    ...
    },
    {
        ...
        submodules: [
            ...
            },
            {
                ...
                icon: List,
                description: 'Real-time pallet readiness',
                actions: ['view'],
            },
            {
                id: 'contract-configs',
                label: 'Contract Configs',
                icon: FileText,
        ...
        submodules: [
            {
                ...
                icon: List,
                description: 'Select pallets for dispatch',
                actions: ['view', 'create', 'edit'],
            },
            {
                id: 'mpl-home',
            ...
            },
            {
                ...
                icon: FileMinus,
                description: 'Shipment batching & stock dispatch',
                actions: ['view', 'create', 'edit'],
            },
        ],
    },
    {
        id: 'bpa',
        label: 'Blanket Order & Release',
        icon: FileText,
        color: '#ec4899',
        description: 'Customer agreements, releases & tariffs',
        actions: ['view', 'create', 'edit', 'delete'],
        submodules: [
            {
                id: 'agreements',
                ...
                icon: FileText,
                description: 'Blanket qty, MIN/MAX, REL MULT',
                actions: ['view', 'create', 'edit', 'delete'],
            },
            {
                id: 'releases',
                ...
                icon: Calendar,
                description: 'Customer PO → FIFO pallet release',
                actions: ['view', 'create', 'edit', 'delete'],
            },
            {
                id: 'tariff-queue',
                label: 'Tariff Queue',
                icon: DollarSign,
                description: 'Finance queue for US tariff invoices',
                actions: ['view', 'create', 'edit'],
            },
        ],
    },
    {
        ...
        icon: Receipt,
        color: '#2563eb',
        description: 'Shipment verify & Goods Receipt',
        actions: ['view', 'create', 'edit'],
    },
    {
        id: 'rack-view',
        ...
        icon: Grid3X3,
        color: '#22c55e',
        description: 'Physical rack placement & movement',
        actions: ['view', 'create', 'edit', 'delete'],
    },
    {
        id: 'forecast',
