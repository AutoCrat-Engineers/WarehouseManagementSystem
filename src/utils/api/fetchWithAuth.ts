 ...
 * 
 * Location: src/utils/api/fetchWithAuth.ts
 * 
 * This file handles all authentication operations with proper error handling
 * and JWT token management.
 * 
 * NOTE: The canonical auth module is at src/utils/supabase/auth.ts.
 * This file re-exports a subset of auth functions used by API service layer,
 * plus the fetchWithAuth() wrapper for authenticated API calls.
 */
